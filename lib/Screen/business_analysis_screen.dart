...
class BusinessAnalysisScreen extends StatefulWidget {
  const BusinessAnalysisScreen({Key? key}) : super(key: key);

  @override
  State<BusinessAnalysisScreen> createState() => _BusinessAnalysisScreenState();
}

class _BusinessAnalysisScreenState extends State<BusinessAnalysisScreen> {
